...
const dataURL = 'https://s3.amazonaws.com/roxiler.com/product_transaction.json'; // Use the external API URL directly
...
const initDb = async () => {
    try {
        ...
        // Insert data into the Transaction collection
...
// Call the initDb function to initialize the database (uncomment this line if you want to initialize automatically)
// initDb();
...
// Get API to fetch the data from all the 3 APIs mentioned above
...
// Uncomment this line to initialize the database automatically when the server starts
// initDb();
